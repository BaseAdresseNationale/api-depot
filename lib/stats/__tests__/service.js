...
test('getCumulFirstRevisionsByDate', t => {
  ...
  const resExpected = [
    ...
    {date: format(sub(new Date(), {days: 6}), 'yyyy-MM-dd'), totalCreations: 1},
    {date: format(sub(new Date(), {days: 5}), 'yyyy-MM-dd'), totalCreations: 2},
    {date: format(sub(new Date(), {days: 4}), 'yyyy-MM-dd'), totalCreations: 3},
    {date: format(sub(new Date(), {days: 3}), 'yyyy-MM-dd'), totalCreations: 4},
    {date: format(sub(new Date(), {days: 2}), 'yyyy-MM-dd'), totalCreations: 5},
    {date: format(sub(new Date(), {days: 1}), 'yyyy-MM-dd'), totalCreations: 6},
