...
export class Initialization1729586137887 implements MigrationInterface {
  name = 'Initialization1729586137887';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "chefs_de_file" ("id" character varying(24) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "nom" text NOT NULL, "email" text NOT NULL, "is_email_public" boolean DEFAULT true, CONSTRAINT "PK_af5269d8a8b4362ff9b3816f307" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "clients" ("id" character varying(24) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "mandataire_id" character varying(24) NOT NULL, "chef_de_file_id" character varying(24), "spec_id" text, "nom" text NOT NULL, "active" boolean DEFAULT true, "mode_relax" boolean DEFAULT true, "token" character varying(32) NOT NULL, "authorization_strategy" "public"."authorization_strategy_enum" NOT NULL, CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "revisions" ("id" character varying(24) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "client_id" character varying(24) NOT NULL, "code_commune" text, "ready" boolean NOT NULL DEFAULT false, "current" boolean NOT NULL DEFAULT false, "status" "public"."status_revision_enum" NOT NULL, "file_id" character varying(24), "file_hash" text, "context" jsonb, "validation" jsonb, "habilitation" jsonb, "published_at" TIMESTAMP, CONSTRAINT "PK_4aa9ee2c71c50508c3c501573c9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_revision_client_id" ON "revisions" ("client_id") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."type_file_enum" AS ENUM('bal')`,
    );
    await queryRunner.query(
      `CREATE TABLE "files" ("id" character varying(24) NOT NULL, "revision_id" character varying(24) NOT NULL, "size" integer, "hash" text NOT NULL DEFAULT false, "type" "public"."type_file_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6c16b9093a142e0e7613b04a3d9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_file_revision_id" ON "files" ("revision_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "files" ADD CONSTRAINT "FK_d2005f96ea67d90fc7d24f17b12" FOREIGN KEY ("revision_id") REFERENCES "revisions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "files" DROP CONSTRAINT "FK_d2005f96ea67d90fc7d24f17b12"`,
    );
    await queryRunner.query(
